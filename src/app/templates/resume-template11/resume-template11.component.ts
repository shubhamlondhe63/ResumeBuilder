...
@Component({
  selector: 'app-resume-template11',
  imports: [CommonModule],
  templateUrl: './resume-template11.component.html',
  styleUrl: './resume-template11.component.css',
})
export class ResumeTemplate11Component {
  @Input() formData: any;
